...
export const IMAGE_SPECIFICATIONS: readonly ImageSpecification[] = [
  ...
  },
  {
    ...
    safeArea: {
      width: 440,
      height: 400,
      note: "Keep the main subject centred so it survives narrower screens.",
    },
    usedFor: ["Category detail page banner"],
    cropBehavior: "Full canvas on desktop; the left and right edges crop progressively on mobile.",
    preferredFormat: "WebP",
    targetFileSize: "250 KB or less",
  },
  {
    ...
    safeArea: {
      width: 800,
      height: 800,
      note: "Keep the food inside this centred square so both 3:2 rails and 4:5 feature tiles crop cleanly.",
    },
    usedFor: ["Category 3:2 rail tile", "Category 4:5 feature tile", "Admin category list"],
    cropBehavior: "Centred object-cover crop; never reuse the wide category banner here.",
    preferredFormat: "WebP",
