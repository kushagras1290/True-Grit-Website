...
const CATALOGUE: Readonly<Record<string, string>> = {
  ...
  "Checkout validates serviceable PIN codes, zone fees, lead times, slot dates and capacity.":
    "Checkout jivvalida kodiċijiet PIN servibbli, miżati taż-żona, ħinijiet ta 'tmexxija, dati ta' slots u kapaċità.",
  Chef: "Kok",
  ...
  "Code (optional — generated if left blank)":
    'Kodiċi ġenerata (f\'għażla) id="t0006">customer@example.com',
  Codes: "Kodiċijiet",
  Collapse: "Kollass",
  ...
  "Configure loyalty, pickup, harvest reservations, delivery logistics and wholesale accounts. Customer access is controlled independently by the five checkboxes in Site Control.":
    "Kkonfigura l-lealtà, il-ġbir, ir-riżervi tal-ħsad, il-loġistika tal-kunsinna u l-kontijiet bl-ingrossa. L-aċċess tal-klijenti huwa kkontrollat ​​b'mod indipendenti mill-ħames kaxxi ta' kontroll fil-Kontroll tas-Sit.",
  ...
  "Create companies, link customers and configure quantity price breaks.":
    "Oħloq kumpaniji, għaqqad klijenti u kkonfigurat waqfiet fil-prezz tal-kwantità.",
  ...
  "Customers can choose an active pickup point at checkout and pay no delivery fee.":
    "Il-klijenti jistgħu jagħżlu punt ta' ġbir attiv waqt iċ-checkout u ma jħallsu l-ebda tariffa tal-kunsinna.",
  "Customers can earn and redeem points and share referral codes. Accounts and ledger history are retained while disabled.":
    "Il-klijenti jistgħu jaqilgħu u jifdu punti u jaqsmu kodiċijiet ta' riferiment. Il-kontijiet u l-istorja tar-reġistru jinżammu waqt li jkunu diżattivati.",
  ...
  "E.g. India Organic, Fair Trade. A certification assigned to any product cannot be deleted until removed from it.":
    "Eż. Indja Organiku, Kummerċ Ġust. Ċertifikazzjoni assenjata lil kwalunkwe prodott ma tistax titħassar sakemm titneħħa minnu.",
  ...
  "E.g. Vegan, Gluten Free. Deleting one removes it from every product that has it checked.":
    "Eż. Vegan, Ħieles Glutina. It-tħassir wieħed ineħħiha minn kull prodott li jkun iċċekkjat.",
  Edit: "Editja",
  ...
  "Enable gift card redemption at checkout":
    "Ippermetti l-fidwa tal-kards tar-rigal waqt iċ-checkout",
  ...
  "Issue a stored-value code redeemable at checkout, covering part or all of an order total. The sitewide on/off switch is on Site Settings, next to the other storefront switches.":
    "Ħruġ kodiċi ta’ valur maħżun li jista’ jinfeda waqt iċ-checkout, li jkopri parti jew kollha ta’ ordni. Is-swiċċ mixgħul/mitfi madwar is-sit jinsab fuq is-Settings tas-Sit, ħdejn is-swiċċijiet l-oħra tal-vetrina.",
  ...
  "Issue one for a customer goodwill gesture, a returned order's store credit, or as a purchasable gift.":
    "Ħruġ waħda għal ġest ta' rieda tajba ta' klijent, kreditu tal-maħżen ta' ordni lura, jew bħala rigal li jista' jinxtara.",
  ...
  "Leave the link blank for a plain, unclickable image.":
    "Ħalli l-link vojta għal immaġni sempliċi u li ma tistax tikklikkja.",
  ...
  "Lets customers apply a gift card code at checkout, covering part or all of their order total. Issue cards from the Gift Cards page. Off by default — existing cards and their balances are kept, just not redeemable, while this is off.":
    "Tħalli lill-klijenti japplikaw kodiċi tal-karta rigal waqt iċ-checkout, li jkopri parti jew it-total tal-ordni tagħhom. Ħruġ karti mill-paġna Gift Cards. Mitfi b'mod awtomatiku — il-karti eżistenti u l-bilanċi tagħhom jinżammu, sempliċement ma jistgħux jinfdew, filwaqt li dan ikun mitfi.",
  "Lets customers narrow the shop grid by dietary tag (Vegan, Gluten Free, ...) and certification. Reads tags and certifications already assigned to products in the product editor — off just hides the filter checkboxes, nothing assigned is lost.":
    "Jħalli lill-klijenti jnaqqsu l-grilja tal-ħanut b'tikketta tad-dieta (Vegan, Glutina Free, ...) u ċertifikazzjoni. Jaqra tikketti u ċertifikazzjonijiet diġà assenjati lill-prodotti fl-editur tal-prodott — off jaħbi biss il-kaxxi ta' kontroll tal-filtru, xejn assenjat ma jintilef.",
  ...
  "Linked business accounts receive quantity price breaks and may use approved invoice terms.":
    "Kontijiet tan-negozju konnessi jirċievu waqfiet fil-prezz tal-kwantità u jistgħu jużaw termini ta' fattura approvati.",
  ...
  "PIN patterns accept an exact value or a trailing wildcard, such as 560*.":
    "Disinnijiet PIN jaċċettaw valur eżatt jew wildcard ta' wara, bħal 560*.",
  Placed: "Imqiegħed",
  ...
  "Review balances and make audited corrections.":
    "Irrevedi l-bilanċi u agħmel korrezzjonijiet verifikati.",
  ...
  "Selected discussions and all their comments will be permanently deleted. This cannot be undone.":
    "Diskussjonijiet magħżula u l-kummenti kollha tagħhom se jitħassru b'mod permanenti. Dan ma jistax jitneħħa.",
  "Selected posts will be removed from the blog and hidden from the admin list.":
    "Karigi magħżula se jitneħħew mill-blog u moħbija mil-lista tal-amministraturi.",
  ...
  "Selected recipes will be removed from the recipes list and hidden from the admin list.":
    "Riċetti magħżula se jitneħħew mil-lista tar-riċetti u moħbija mil-lista tal-amministraturi.",
  ...
  "The checkbox lists shown on every product's General tab. Changes apply everywhere immediately.":
    "Il-listi tal-kaxxa ta' kontroll murija fit-tab Ġenerali ta' kull prodott. Il-bidliet japplikaw kullimkien immedjatament.",
  ...
  "This removes the selected items for good — they can no longer be restored. Items still referenced by orders or other records (for example a product with order history) will be skipped with an error.":
    "Dan l-ebda oġġetti magħżula ma jistgħux jiġu restawrati għall-aħjar. Oġġetti li għadhom referenzjati minn ordnijiet jew rekords oħra (pereżempju prodott bi storja ta' ordnijiet) se jinqabżu bi żball.",
  ...
  "Use a separate 1200 × 1200 image. This square image is cropped for category cards; do not reuse the wide hero banner.":
    "Uża immaġni separata ta' 1200 × 1200. Din l-immaġni kwadra hija maqtugħa għall-karti tal-kategorija; tużax mill-ġdid il-banner wiesa' tal-eroj.",
