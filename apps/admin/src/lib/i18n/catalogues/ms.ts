...
const CATALOGUE: Readonly<Record<string, string>> = {
  ...
  ", but only until you sign in once. After that this account owns its password, and editing":
    ", tetapi hanya sehingga anda log masuk sekali. Selepas itu akaun ini memiliki kata laluannya dan mengedit",
  ", on every page that does not have its own colours.":
    ", pada setiap halaman yang tidak mempunyai warnanya sendiri.",
  ", rendered at the same size as the homepage hero. Left blank, the shipped hero image is used so the space is never empty.":
    ", dipaparkan pada saiz yang sama seperti wira halaman utama. Dibiarkan kosong, imej wira yang dihantar digunakan supaya ruang tidak pernah kosong.",
  ", rendered at the same size as the homepage hero. Left blank, the shipped hero image is used so the space is never empty. Each individual farm page has its own banner image, set on that farm's edit page.":
    ", dipaparkan pada saiz yang sama dengan wira halaman utama. Dibiarkan kosong, imej wira yang dihantar digunakan supaya ruang tidak pernah kosong. Setiap halaman ladang individu mempunyai imej sepanduk sendiri, ditetapkan pada halaman edit ladang itu.",
  ", which is the ceiling the block format itself enforces. Lowering it never deletes slides you have already saved; it only stops new ones being added.":
    ", iaitu siling yang dikuatkuasakan oleh format blok itu sendiri. Menurunkannya tidak akan memadamkan slaid yang telah anda simpan; ia hanya menghentikan yang baharu ditambahkan.",
  ". They can use it to set a new password.":
    ". Mereka boleh menggunakannya untuk menetapkan kata laluan baharu.",
  ...
  "5xx AppErrors and unhandled exceptions will show up here as they happen.":
    "5xx AppErrors dan pengecualian tidak dikendalikan akan dipaparkan di sini semasa ia berlaku.",
  ...
  "A farm owner is a sub-admin who can only manage their own farm's products and stock.":
    "Pemilik ladang ialah sub-pentadbir yang hanya boleh menguruskan produk dan stok ladang mereka sendiri.",
  "A list of content blocks (rich_text, product_collection, farmer_story, faq). Inside a rich_text paragraph, write":
    "Senarai blok kandungan (rich_text, product_collection, farmer_story, faq). Di dalam perenggan rich_text, tulis",
  ...
  "A product can hold at most 8 gallery images.":
    "Produk boleh menyimpan paling banyak 8 imej galeri.",
  "A promotion with no coupon codes applies automatically to every eligible cart. Add one or more codes to make it code-gated instead. The sitewide on/off switch is on Site Settings, next to the other storefront switches.":
    "Promosi tanpa kod kupon dikenakan secara automatik pada setiap troli yang layak. Tambah satu atau lebih kod untuk menjadikannya berpagar kod sebaliknya. Suis hidup/mati seluruh tapak berada pada Tetapan Tapak, bersebelahan dengan suis etalase yang lain.",
  "A signed price adjustment: positive raises the real price (a markup), negative genuinely lowers it (a discount). Target one product, one category, or every product — globally or in one country.":
    "Pelarasan harga yang ditandatangani: positif menaikkan harga sebenar (penanda), negatif benar-benar menurunkannya (diskaun). Sasarkan satu produk, satu kategori atau setiap produk — secara global atau dalam satu negara.",
  ...
  "A super admin can start a group or direct message from the + button above.":
    "Pentadbir super boleh memulakan kumpulan atau mesej terus daripada butang + di atas.",
  ...
  "Add items (which variants, how many of each) after creating the bundle, from Manage.":
    "Tambahkan item (varian yang mana, berapa banyak setiap satu) selepas membuat himpunan, daripada Urus.",
  ...
  "Add one so the bot has something to reference for this scope.":
    "Tambah satu supaya bot mempunyai sesuatu untuk dirujuk untuk skop ini.",
  ...
  "Alphonso season is here — orchard-fresh boxes ship every Tuesday.":
    "Musim Alphonso sudah tiba — kotak segar dusun dihantar setiap hari Selasa.",
  "Alt text": "Teks Alt",
  "Alt text describes the image rather than repeating the page title.":
    "Teks Alt menerangkan imej dan bukannya mengulangi tajuk halaman.",
  Alter: "Ubah",
  ...
  "and marks them settled, so they can never be paid twice. It does":
    "dan tandakan ia diselesaikan, jadi ia tidak boleh dibayar dua kali. Ia",
  ...
  "Appears above the contact form on checkout and in the basket summary. Up to 600 characters.":
    "Terpapar di atas borang hubungan semasa daftar keluar dan dalam ringkasan bakul. Sehingga 600 aksara.",
  "Appears above the customer storefront, on every page. A country's banner fully replaces the site-wide one for its visitors when it is on — an owner silencing a market-specific announcement does not have the general one reappear underneath it.":
    "Muncul di atas etalase pelanggan, pada setiap halaman. Sepanduk negara menggantikan sepenuhnya sepanduk di seluruh tapak untuk pelawatnya apabila ia dihidupkan — pemilik yang menyenyapkan pengumuman khusus pasaran tidak mempunyai sepanduk umum yang muncul semula di bawahnya.",
  "Append-only. Actor, action, entity, and request id for every sensitive operation.":
    "Tambahkan sahaja. Pelakon, tindakan, entiti dan id permintaan untuk setiap operasi sensitif.",
  Applicant: "Pemohon",
  "Applications from the storefront's partnership form appear here.":
    "Aplikasi daripada borang perkongsian etalase muncul di sini.",
  "Applied at checkout before any coupon or promotion discount. Orders at or above the free-delivery threshold pay no delivery fee.":
    "Digunakan semasa pembayaran sebelum sebarang kupon atau promosi. Pesanan pada atau melebihi ambang penghantaran percuma tidak membayar yuran penghantaran.",
  ...
  "available · reorder at":
    'tersedia id="t0005">Tersedia sentiasa diperolehi (di tangan − terpelihara). Setiap perubahan adalah pergerakan.',
  "Available is always derived (on hand − reserved). Every change is a movement.":
    "Tersedia sentiasa diperolehi (di tangan − ditempah). Setiap perubahan adalah pergerakan.",
  ...
  "banners — it saves with the rest of the homepage, no deploy needed. Up to":
    "sepanduk — ia disimpan bersama halaman utama yang lain, tidak perlu menggunakan sepanduk. Sehingga",
  ...
  "Blog posts and recipes pitched by the community, awaiting review.":
    "Siaran blog dan resipi yang dikemukakan oleh komuniti, menunggu semakan.",
  "Bloggers draft and submit posts here; reviewers approve and publish.":
    "Blogger mendraf dan menyerahkan siaran di sini; pengulas meluluskan dan menerbitkan.",
  Body: "Badan",
  "Body text": "Teks isi",
  Bosnian: "Bosnia",
  ...
  "Canvas matches the exact pixel dimensions above.":
    "Kanvas sepadan dengan dimensi piksel tepat di atas.",
  Capacity: "Kapasiti",
  Caption: "Kapsyen",
  ...
  "Catalogue, inventory, content, orders, users and audit events in one operating surface.":
    "Katalog, inventori, kandungan, pesanan, pengguna dan acara audit dalam satu permukaan operasi.",
  Categories: "Kategori",
  ...
  "Check that this account has users.view permission and that the API is connected.":
    "Semak sama ada akaun ini mempunyai kebenaran users.view dan bahawa API disambungkan.",
  ...
  "Checkout validates serviceable PIN codes, zone fees, lead times, slot dates and capacity.":
    "tarikh slot semakan yang sah, kod slot yang sah kapasiti.",
  "Chefs draft and submit recipes here; reviewers approve and publish.":
    "Chef draf dan serahkan resipi di sini; pengulas meluluskan dan menerbitkan.",
  ...
  "Configure loyalty, pickup, harvest reservations, delivery logistics and wholesale accounts. Customer access is controlled independently by the five checkboxes in Site Control.":
    "Konfigurasikan kesetiaan, pengambilan, tempahan tuaian, logistik penghantaran dan akaun borong. Akses pelanggan dikawal secara bebas oleh lima kotak pilihan dalam Kawalan Tapak.",
  ...
  "Create companies, link customers and configure quantity price breaks.":
    "Buat syarikat, pautkan pelanggan dan konfigurasikan pecahan harga kuantiti.",
  ...
  "Create one to run a sitewide discount or issue coupon codes.":
    "Buat ladang untuk menjalankan diskaun seluruh tapak atau mengeluarkan kod kupon.",
  "Create one to sell a curated set of products together at a set price.":
    "Buat satu untuk menjual set produk yang dipilih susun bersama-sama pada harga yang ditetapkan.",
  "Create partner farms before assigning products or farm-owner accounts.":
    "Buat ladang rakan kongsi sebelum menetapkan produk atau akaun pemilik ladang.",
  ...
  "Curated sets of specific variants sold together at a flat price. Checkout applies the saving automatically once a basket holds every item in a bundle.":
    "set harga rata yang tertentu. Checkout menggunakan penjimatan secara automatik apabila bakul menyimpan setiap item dalam satu berkas.",
  Currency: "Mata Wang",
  ...
  "Customer-filed return requests, from request through resolution.":
    "Permintaan pemulangan yang difailkan pelanggan, daripada permintaan melalui penyelesaian.",
  "Customers can choose an active pickup point at checkout and pay no delivery fee.":
    "Pelanggan dan penerima tidak boleh memilih pembayaran yang aktif yuran.",
  "Customers can earn and redeem points and share referral codes. Accounts and ledger history are retained while disabled.":
    "Pelanggan boleh memperoleh dan menebus mata dan berkongsi kod rujukan. Sejarah akaun dan lejar dikekalkan semasa dilumpuhkan.",
  ...
  "Default. Orderable exactly when Site Control's payments switch is on.":
    "Lalai. Boleh dipesan tepat apabila suis pembayaran Kawalan Tapak dihidupkan.",
  Delete: "Padam",
  ...
  "Demo mode has no API, so a password change cannot be saved. Set":
    "kata laluan tidak boleh ditukar. Tetapkan",
  "Describe the image for screen readers. Leave blank if it is purely decorative — the banner heading already carries the meaning.":
    "Terangkan imej untuk pembaca skrin. Biarkan kosong jika ia adalah hiasan semata-mata — tajuk sepanduk sudah membawa maksud.",
  ...
  "Discussions and comments started by customers.":
    "Perbincangan dan ulasan yang dimulakan oleh pelanggan.",
  Dismiss: "Ketepikan",
  ...
  "dresses every article under it, so you do not have to list them.":
    "memakai setiap artikel di bawahnya, jadi anda tidak perlu menyenaraikannya.",
  ...
  "E.g. India Organic, Fair Trade. A certification assigned to any product cannot be deleted until removed from it.":
    "Cth. India Organik, Perdagangan Adil. Pensijilan yang diberikan kepada mana-mana produk tidak boleh dipadamkan sehingga dialih keluar daripadanya.",
  ...
  "E.g. Vegan, Gluten Free. Deleting one removes it from every product that has it checked.":
    "Cth. Vegan, Tanpa Gluten. Memadam satu akan mengalih keluarnya daripada setiap produk yang telah disemak.",
  "Edit CMS page metadata, indexing and raw page blocks. The homepage record is listed here too, but Homepage Settings is the safer way to change it — this editor takes raw JSON.":
    "Edit metadata halaman CMS, pengindeksan dan sekatan halaman mentah. Rekod halaman utama juga disenaraikan di sini, tetapi Tetapan Halaman Utama ialah cara yang lebih selamat untuk menukarnya — editor ini menggunakan JSON mentah.",
  ...
  "Every organic product we carry, in one place.":
    "Setiap produk organik yang kami bawa, di satu tempat.",
  "Every refund issued across all orders, owner-only oversight of the Accounts role.":
    "Setiap bayaran balik yang dikeluarkan merentas semua pesanan, pengawasan pemilik sahaja terhadap peranan Akaun.",
  "Every uploaded image, with alt text and captions editable in place.":
    "Setiap imej yang dimuat naik, dengan teks alt dan kapsyen boleh diedit pada tempatnya.",
  "Exact upload canvases and crop-safe areas for every image surface on the storefront.":
    "Kavas muat naik yang tepat dan kawasan selamat pangkas untuk setiap permukaan imej di etalase.",
  Excerpt: "Petikan",
  ...
  "Farms appear here once they exist and have sold something.":
    "Ladang muncul di sini sebaik sahaja ia wujud dan telah menjual sesuatu.",
  ...
  "Google Identity Services button in the storefront account menu.":
    "Butang Perkhidmatan Identiti Google dalam menu akaun etalase.",
  ...
  "If that email has an account, a reset link is on its way.":
    "Jika e-mel itu mempunyai akaun, pautan set semula sedang dalam perjalanan.",
  "If this promotion has never been redeemed it is deleted outright; otherwise it is archived so its history is kept.":
    "Jika promosi ini tidak pernah ditebus, ia akan dipadamkan terus; jika tidak, ia diarkibkan supaya sejarahnya disimpan.",
  Image: "Imej",
  ...
  "Image is sRGB and at or below the listed file-size target.":
    "Imej berada di bawah atau di bawah senaraiRGB target.",
  ...
  "is not a valid colour. Use a hex value such as #24483a.":
    "bukan warna yang sah. Gunakan nilai heks seperti #24483a.",
  ...
  "Issue a stored-value code redeemable at checkout, covering part or all of an order total. The sitewide on/off switch is on Site Settings, next to the other storefront switches.":
    "dikeluarkan kod di kedai-kedai semula atau kesemua jumlah pesanan. Suis hidup/mati seluruh tapak berada pada Tetapan Tapak, bersebelahan dengan suis etalase yang lain.",
  ...
  "Issue one for a customer goodwill gesture, a returned order's store credit, or as a purchasable gift.":
    "Keluarkan satu untuk isyarat muhibah pelanggan, kredit kedai pesanan yang dikembalikan atau sebagai hadiah yang boleh dibeli.",
  ...
  "Leave the link blank for a plain, unclickable image.":
    "Biarkan pautan kosong untuk imej biasa dan tidak boleh diklik.",
  ...
  "Lets customers apply a gift card code at checkout, covering part or all of their order total. Issue cards from the Gift Cards page. Off by default — existing cards and their balances are kept, just not redeemable, while this is off.":
    "Membolehkan pelanggan menggunakan kod kad hadiah semasa pembayaran, meliputi sebahagian atau keseluruhan jumlah pesanan mereka. Keluarkan kad daripada halaman Kad Hadiah. Dimatikan secara lalai — kad sedia ada dan bakinya disimpan, cuma tidak boleh ditebus, sementara ini dimatikan.",
  "Lets customers narrow the shop grid by dietary tag (Vegan, Gluten Free, ...) and certification. Reads tags and certifications already assigned to products in the product editor — off just hides the filter checkboxes, nothing assigned is lost.":
    "Membolehkan pelanggan mengecilkan grid kedai dengan teg diet (Vegan, Tanpa Gluten, ...) dan pensijilan. Membaca teg dan pensijilan yang telah diberikan kepada produk dalam editor produk — dimatikan hanya menyembunyikan kotak semak penapis, tiada apa yang ditetapkan hilang.",
  "Lets customers set up recurring cash-on-delivery deliveries of a product from its product page. Off by default and not needed at launch — existing subscriptions are kept and viewable in Subscriptions, just not renewed, while this is off.":
    "Membolehkan pelanggan menyediakan penghantaran tunai semasa penghantaran berulang produk daripada halaman produknya. Dimatikan secara lalai dan tidak diperlukan semasa pelancaran — langganan sedia ada disimpan dan boleh dilihat dalam Langganan, cuma tidak diperbaharui, sementara ini dimatikan.",
  Level: "Tahap",
  ...
  "Linked business accounts receive quantity price breaks and may use approved invoice terms.":
    "Akaun perniagaan yang dipautkan menerima potongan harga kuantiti dan boleh menggunakan syarat invois yang diluluskan.",
  ...
  "links and a product_collection block to highlight the products used in this recipe.":
    "pautan dan blok koleksi_produk untuk menyerlahkan produk yang digunakan dalam resipi ini.",
  ...
  "Messages sent from the storefront contact page will appear here.":
    "Mesej yang dihantar dari halaman hubungan etalase akan dipaparkan di sini.",
  "Messages submitted from the storefront Contact us page.":
    "Mesej dihantar dari halaman Hubungi kami di hadapan etalase.",
  ...
  "Never accept payments for this product":
    "Jangan sekali-kali menerima pembayaran untuk produk ini",
  "New account sign-ups": "Pendaftaran akaun baharu",
  "New and updated rules apply to the live storefront immediately.":
    "Peraturan baharu dan dikemas kini digunakan pada etalase langsung dengan serta-merta.",
  ...
  "New sections arrive switched off with placeholder copy, so nothing half-written reaches a customer. The banner, category row and product row are edited in their own panels below and cannot be deleted — untick them to hide them.":
    "Bahagian baharu tiba dimatikan dengan salinan pemegang tempat, jadi tiada apa-apa yang separuh bertulis sampai kepada pelanggan. Sepanduk, baris kategori dan baris produk diedit dalam panelnya sendiri di bawah dan tidak boleh dipadamkan — nyahtandanya untuk menyembunyikannya.",
  ...
  "No active promotions yet. Create one from Coupons & Promotions, then come back here to feature it.":
    "Tiada promosi aktif lagi. Buat satu daripada Kupon & Promosi, kemudian kembali ke sini untuk menampilkannya.",
  "No approved reviews yet. Approve some from the Reviews page, then come back here to feature them.":
    "Tiada ulasan yang diluluskan lagi. Luluskan beberapa daripada halaman Ulasan, kemudian kembali ke sini untuk menampilkannya.",
  ...
  "No highlighted products yet. Add a few below.":
    "Tiada produk yang diserlahkan lagi. Tambahkan beberapa di bawah.",
  ...
  "No items yet — add at least one below. Checkout only applies this bundle's discount when the basket has every item here, in at least these quantities.":
    "Tiada item lagi — tambahkan sekurang-kurangnya satu di bawah. Daftar keluar hanya menggunakan diskaun berkas ini apabila bakul mempunyai setiap item di sini, sekurang-kurangnya dalam kuantiti ini.",
  ...
  "no longer changes the login — so a password you set here really does replace the old one.":
    "tidak lagi mengubah log masuk — jadi kata laluan yang anda tetapkan di sini benar-benar menggantikan yang lama.",
  ...
  "No saved translation for this locale yet — showing English as a starting point.":
    "Belum disimpan dalam bahasa Inggeris ini — Terjemahan tempatan belum disimpan untuk ini. titik.",
  ...
  "No sign-in method is available. Customers cannot sign in or reach their orders until at least one is switched back on.":
    "Tiada kaedah log masuk tersedia. Pelanggan tidak boleh log masuk atau mencapai pesanan mereka sehingga sekurang-kurangnya satu dihidupkan semula.",
  ...
  "Note (required to request changes or reject)":
    "Nota (diperlukan untuk meminta perubahan atau menolak)",
  ...
  "Off closes checkout entirely and shows customers a contact form instead, so interest is still captured. Baskets are left untouched.":
    "Mati menutup pembayaran sepenuhnya dan sebaliknya menunjukkan kepada pelanggan borang hubungan, jadi minat masih ditangkap. Bakul dibiarkan tanpa disentuh.",
  "Off hides the promotions banner on the homepage and checkout, and any coupon code is refused at checkout. Existing promotions and coupons are kept, just not applied.":
    "Off menyembunyikan sepanduk promosi pada halaman utama dan pembayaran, dan sebarang kod kupon ditolak semasa pembayaran. Promosi dan kupon sedia ada disimpan, cuma tidak digunakan.",
  On: "Hidup",
  "On hand": "Di tangan",
  ...
  "One composition engine renders every category — no code per category.":
    "Satu enjin gubahan memaparkan setiap kategori — tiada kod bagi setiap kategori.",
  "One considered letter a month. Unsubscribe anytime.":
    "Satu huruf dipertimbangkan sebulan. Nyahlanggan pada bila-bila masa.",
  "One line on what the customer will find there.":
    "Satu baris mengenai perkara yang pelanggan akan temui di sana.",
  "One specific promotion": "Satu promosi khusus",
  "Only main admins can review farm applications.":
    "Hanya pentadbir utama boleh menyemak aplikasi ladang.",
  "Only main admins can view customer contact messages.":
    'Hanya pentadbir hubungan utama><span yang boleh melihat pelanggan. id="t0004">Hanya akaun pemilik boleh mengedit sitemap.xml, robots.txt dan llms.txt.',
  "Only the owner account can edit sitemap.xml, robots.txt and llms.txt.":
    "Hanya akaun pemilik boleh mengedit sitemap.xml, robots.txt dan llms.txt.",
  ...
  "Only the owner can review payments and refunds.":
    "Hanya pemilik boleh menyemak pembayaran dan bayaran balik.",
  ...
  "Orderable even while the site-wide switch is off.":
    "Boleh dipesan walaupun semasa suis seluruh tapak dimatikan.",
  Ordering: "Pesanan",
  Orders: "Pesanan",
  "Orders will appear here once customers check out.":
    "Pesanan akan dipaparkan di sini sebaik sahaja pelanggan mendaftar keluar.",
  ...
  "Owner-only controls for /sitemap.xml, /robots.txt and /llms.txt.":
    "Kawalan pemilik sahaja untuk /sitemap.xml, /robots.txt dan /llms.txt.",
  "Owner-only. Read-only browser over every table — no arbitrary SQL is ever accepted from the client.":
    "Pemilik sahaja. Penyemak imbas baca sahaja pada setiap jadual — tiada SQL sewenang-wenangnya pernah diterima daripada klien.",
  Page: "Halaman",
  ...
  "Pick a report, set optional filters, and run it. No free-text SQL ever reaches the database.":
    "Pilih laporan, tetapkan penapis pilihan dan jalankannya. Tiada SQL teks percuma yang pernah sampai ke pangkalan data.",
  "Pick at least one country, or release everywhere.":
    "Pilih sekurang-kurangnya satu negara atau keluarkan di mana-mana sahaja.",
  "Pick at least one country, or release globally.":
    "Pilih sekurang-kurangnya satu negara atau keluarkan secara global.",
  ...
  "PIN patterns accept an exact value or a trailing wildcard, such as 560*.":
    "Corak PIN menerima nilai yang tepat atau kad bebas mengekori, seperti 560*.",
  Placed: "Diletakkan",
  ...
  "Preview is checked on both a narrow phone and a desktop screen.":
    "Pratonton disemak pada kedua-dua telefon sempit dan skrin desktop.",
  Previous: "Sebelumnya",
  Price: "Harga",
  ...
  "Reader comments on blog posts and recipes appear here.":
    "Ulasan pembaca pada catatan blog dan resipi di blog muncul di sini.",
  ...
  "Real bestsellers and “customers also bought” rows, computed live from actual orders — on the homepage, product pages, basket, category pages, search and the shop. Off removes every one of them; nothing is curated, so there is nothing to lose by switching it back on.":
    'Baris terlaris sebenar dan "pelanggan turut membeli", dikira secara langsung daripada pesanan sebenar — di halaman utama, halaman produk, bakul, halaman kategori, carian dan kedai. Off mengalih keluar setiap satu daripada mereka; tiada yang dipilih susun, jadi tiada apa yang rugi dengan menghidupkannya semula.',
  ...
  "Recover hidden products, categories, farms and CMS pages.":
    "Pulihkan produk tersembunyi, kategori, ladang dan halaman CMS.",
  ...
  "Requires pages.view permission and a connected API.":
    "Memerlukan kebenaran page.view dan API yang disambungkan.",
  ...
  "Revenue, orders and top products, computed live from real orders -- never a stored rollup that can drift from what checkout actually recorded.":
    "Hasil, pesanan dan produk teratas, dikira secara langsung daripada pesanan sebenar -- tidak boleh dikira secara langsung daripada pesanan sebenar direkodkan.",
  Review: "Semak",
  ...
  "Roles are collections of permissions; the API checks permissions, never role names.":
    "Peranan ialah koleksi kebenaran; API menyemak kebenaran, jangan sekali-kali menamakan peranan.",
  ...
  "Say how often you will write and that unsubscribing is easy.":
    "Sebutkan kekerapan anda menulis dan berhenti melanggan adalah mudah.",
  Scope: "Skop",
  ...
  "Selected categories will be hidden from the storefront and removed from the active catalogue.":
    "Kategori yang dipilih akan disembunyikan daripada etalase dan dialih keluar daripada katalog aktif.",
  "Selected discussions and all their comments will be permanently deleted. This cannot be undone.":
    "Perbincangan yang dipilih dan semua ulasannya akan dipadamkan secara kekal. Ini tidak boleh dibuat asal.",
  "Selected posts will be removed from the blog and hidden from the admin list.":
    "Siaran yang dipilih akan dialih keluar daripada blog dan disembunyikan daripada senarai pentadbir.",
  "Selected products will be hidden from the storefront and removed from the active catalogue.":
    "Produk yang dipilih akan disembunyikan daripada etalase dan dialih keluar daripada katalog aktif.",
  "Selected recipes will be removed from the recipes list and hidden from the admin list.":
    "Resipi yang dipilih akan dialih keluar daripada senarai resipi dan disembunyikan daripada senarai pentadbir.",
  "Selected rows will be cleared to reserved stock, making available stock zero while preserving reservations, movement history and audit logs.":
    "Baris yang dipilih akan dikosongkan kepada stok tersimpan, menjadikan stok tersedia sifar sambil mengekalkan tempahan, sejarah pergerakan dan log audit.",
  "Selected users will be removed from the users list and signed out.":
    "Pengguna yang dipilih akan dialih keluar daripada senarai pengguna dan dilog keluar.",
  Send: "Hantar",
  "Send a secure password reset link to this user. They will set their new password from the admin reset page.":
    "Hantar pautan tetapan semula kata laluan yang selamat kepada pengguna ini. Mereka akan menetapkan kata laluan baharu mereka daripada halaman tetapan semula pentadbir.",
  ...
  "Shown at the top of the recipe and as its thumbnail on the recipes listing.":
    "Ditunjukkan di bahagian atas resipi dan sebagai lakaran kecilnya pada penyenaraian resipi.",
  "Shown even if a higher-priority automatic promotion is also active.":
    "Ditunjukkan walaupun promosi automatik dengan keutamaan yang lebih tinggi turut aktif.",
  "Shown in the “Goes well with” slots on this product’s page, in this order. Leave empty to let the storefront pick from the same category.":
    'Ditunjukkan dalam slot "Sesuai dengan" pada halaman produk ini, dalam susunan ini. Biarkan kosong untuk membiarkan etalase memilih daripada kategori yang sama.',
  "Shown in the Fresh favourites slider on the homepage. Only published products appear to customers.":
    "Ditunjukkan dalam peluncur kegemaran Segar di halaman utama. Hanya produk yang diterbitkan dipaparkan kepada pelanggan.",
  "Shown in the highlights box on the storefront search page, in this order. Only published products appear to customers.":
    "Ditunjukkan dalam kotak sorotan pada halaman carian etalase, dalam susunan ini. Hanya produk yang diterbitkan dipaparkan kepada pelanggan.",
  "Shown on the homepage banner and at checkout.":
    "Ditunjukkan pada sepanduk halaman utama dan semasa pembayaran.",
  "Shows behind and around banner images.":
    "Tunjukkan di belakang dan di sekeliling imej sepanduk.",
  "Sign in": "Log masuk",
  "Sign in and sign up with nothing but a phone number.":
    "Log masuk dan daftar tanpa apa-apa kecuali nombor telefon.",
  ...
  "Site-wide controls: the announcement banner, storefront switches, CMS pages, per-route SEO and crawler files. The homepage itself has its own page.":
    "Kawalan seluruh tapak: sepanduk pengumuman, suis etalase, halaman CMS, SEO setiap laluan dan fail perangkak. Halaman utama itu sendiri mempunyai halamannya sendiri.",
  ...
  "Slug (optional — derived from the name if blank)":
    "Slug (pilihan — berasal daripada nama jika kosong)",
  ...
  "Super administrator access required":
    'Akses pentadbir super diperlukan" id.><Superpan-sahaja Ralat aplikasi dan pengecualian tidak dikendalikan, terbaharu dahulu.',
  ...
  "The banner, category row, product row and SEO fields save together. Section tickboxes, ordering and custom section copy save on their own, as you change them.":
    "Sepanduk, baris kategori, baris produk dan medan SEO disimpan bersama-sama. Kotak tanda bahagian, pesanan dan salinan bahagian tersuai disimpan sendiri, semasa anda mengubahnya.",
  "The chat widget customers and visitors see on the storefront.":
    "Widget sembang yang dilihat pelanggan dan pelawat di etalase.",
  "The checkbox lists shown on every product's General tab. Changes apply everywhere immediately.":
    "Senarai kotak pilihan ditunjukkan pada setiap tab Umum produk. Perubahan berlaku di mana-mana serta-merta.",
  "The classic credential pair, including the password-reset flow.":
    "Pasangan bukti kelayakan klasik, termasuk aliran penetapan semula kata laluan.",
  "the farm owner": "pemilik ladang",
  "The floating Help Assistant staff see on every admin page.":
    "Kakitangan Pembantu Bantuan terapung lihat pada setiap halaman pentadbir.",
  'The header and footer link labels every page shows, translated per language (migration 0068). A locale left blank falls back to English on the storefront. This is the same control that fixes a header showing "Shop" / "Seasonal" in English while everything around it has switched language — those labels come from here, not from the page content translations above.':
    'Pengepala dan pautan pengaki setiap halaman menunjukkan setiap bahasa (g) pautan yang diterjemahkan setiap halaman (g008). Tempat yang dibiarkan kosong kembali kepada bahasa Inggeris di etalase. Ini ialah kawalan yang sama yang membetulkan pengepala yang menunjukkan "Beli" / "Bermusim" dalam bahasa Inggeris sementara segala-galanya di sekelilingnya telah menukar bahasa — label tersebut datang dari sini, bukan daripada terjemahan kandungan halaman di atas.',
  ...
  "The identity this console signs you in as, and the password it uses.":
    "Identiti yang dilog masuk oleh konsol ini dan kata laluan yang digunakannya.",
  "The market": "Pasaran",
  ...
  "The page goes back to the site-wide colours. Nothing else about the page changes.":
    "Halaman itu kembali kepada warna seluruh tapak. Tiada apa-apa lagi tentang halaman yang berubah.",
  "The quiet revival of Indian millets": "Kebangkitan senyap millet India",
  "The role list could not be loaded from the API.":
    "Senarai peranan tidak dapat dimuatkan daripada API.",
  "The rotating banner at the top of the homepage, plus the fallback copy shown when no slide has an image.":
    "Sepanduk berputar di bahagian atas halaman utama, serta salinan sandaran yang ditunjukkan apabila tiada slaid mempunyai imej.",
  ...
  "The upload API accepts JPG, PNG, WebP, and GIF files up to 5 MB. These stricter targets keep storefront pages fast and visually predictable.":
    "API muat naik menerima fail JPG, PNG, WebP dan GIF sehingga 5 MB. Sasaran yang lebih ketat ini memastikan halaman depan kedai dengan pantas dan boleh diramal secara visual.",
  "These are created by customers from a product page, once Subscribe & Save is switched on in Site Settings.":
    "Ini dibuat oleh pelanggan daripada halaman produk, sebaik Langgan & Simpan dihidupkan dalam Tetapan Tapak.",
  ...
  "This permanently removes the image from storage. Images still referenced by a product, page, article or recipe cannot be deleted.":
    "Ini mengalih keluar imej daripada storan secara kekal. Imej yang masih dirujuk oleh produk, halaman, artikel atau resipi tidak boleh dipadamkan.",
  ...
  "This removes the bundle and its item list. Orders that already used it keep their own record.":
    "Ini mengalih keluar berkas dan senarai itemnya. Pesanan yang sudah menggunakannya menyimpan rekod mereka sendiri.",
  "This removes the selected items for good — they can no longer be restored. Items still referenced by orders or other records (for example a product with order history) will be skipped with an error.":
    "Selebihnya, item ini tidak boleh dipilih lagi. Item yang masih dirujuk oleh pesanan atau rekod lain (contohnya produk dengan sejarah pesanan) akan dilangkau dengan ralat.",
  ...
  "This section is edited in its own panel further down the page.":
    "Bahagian ini diedit dalam panelnya sendiri lebih jauh ke bawah halaman.",
  "Threads started from the storefront appear here.":
    "Benang yang bermula dari etalase muncul di sini.",
  ...
  "Title, description, keywords and indexing for storefront routes that aren't backed by a CMS page above. Leave a field blank to keep that route's built-in default.":
    "Tajuk, penerangan, kata kunci dan pengindeksan untuk laluan etalase yang tidak disokong oleh halaman CMS di atas. Biarkan medan kosong untuk mengekalkan lalai terbina dalam laluan itu.",
  "to add a link — plain text and internal/external URLs only, never raw HTML.":
    "untuk menambah pautan — teks biasa dan URL dalaman/luaran sahaja, bukan HTML mentah.",
  ...
  "Use WebP unless PNG is specified. Do not bake text or logos into photographs.":
    "Gunakan WebP melainkan PNG ditentukan. Jangan bakar teks atau logo ke dalam gambar.",
  ...
  "Visit notes, or the reason for declining — emailed to the applicant on approve/reject.":
    "Lawati nota atau sebab penolakan — dihantar melalui e-mel kepada pemohon untuk meluluskan/menolak.",
  "Visitors from this country go back to seeing the site-wide banner (or none, if that is off).":
    "sepanduk ke seluruh negara ini jika itu dimatikan).",
  "Visitors from this country go back to the site-wide colours. Nothing else about the country changes.":
    "Pelawat dari negara ini kembali kepada warna seluruh tapak. Tiada apa-apa lagi tentang negara yang berubah.",
  "Visitors outside the released countries will not see this category page at all — the same per-country control already used for products.":
    "Pelawat di luar negara yang dikeluarkan tidak akan melihat halaman kategori ini sama sekali — kawalan setiap negara yang sama telah digunakan untuk produk.",
  "Visitors outside the released countries will not see this product anywhere on the storefront.":
    "Pelawat di luar negara yang dikeluarkan tidak akan melihat produk ini di mana-mana sahaja di etalase.",
  Warning: "Amaran",
  Website: "Tapak web",
  ...
  "What customers see on the homepage: which sections run, in what order, and the copy inside them.":
    "Perkara yang dilihat oleh pelanggan di halaman utama: bahagian mana yang dijalankan, mengikut susunan dan salinan di dalamnya.",
  "What each farm has earned, the platform's cut, and payments to farm owners.":
    "Apa yang diperolehi oleh setiap ladang, potongan platform dan bayaran kepada pemilik ladang.",
  ...
  "You need the Coupons & Promotions permission to pick a specific promotion here.":
    "Anda memerlukan kebenaran Kupon & Promosi untuk memilih promosi tertentu di sini.",
  "Your Account": "Akaun Anda",
  "Your current password is required, and every other signed-in session is ended.":
    "Kata laluan semasa anda diperlukan dan setiap sesi log masuk yang lain telah ditamatkan.",
  "Zone ID": "ID Zon",
};
