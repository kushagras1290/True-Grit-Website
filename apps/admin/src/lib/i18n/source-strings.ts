...
const ADMIN_SOURCE_STRINGS = [
  ...
  "Adding…",
  "Address",
  "Adds after a recommendation click",
  "Adjust points",
  ...
  "Could not load this feature.",
  "Countries",
  "Countries in this bracket",
  "Country",
  ...
  "Enable B2B and bulk ordering",
  "Enable coupons and promotions",
  "Enable gift card redemption at checkout",
  "Enable local pickup",
  "Enable loyalty points and referrals",
  "Enable seasonal pre-orders",
  "Enable selected (",
  "Enable Subscribe & Save",
  "Enable the refund agent",
  "Enabled",
  "Ends",
  "Ends (optional)",
  ...
  "Statistical Significance (mSPRT)",
  ...
  "When",
  "When enabled, every storefront request renders English, skips geo/header language selection, and hides the language picker. Saved language packs remain untouched.",
