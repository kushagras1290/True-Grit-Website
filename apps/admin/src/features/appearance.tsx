...
const AMBIENT_LABELS: Record<AmbientEffectKey, string> = {
  ...
  stardust: "Stardust",
  galaxySwirl: "Galaxy swirl",
  nebulaClouds: "Nebula clouds",
  supernovaFlashes: "Supernova flashes",
  lightningFlashes: "Lightning flashes",
  hailstorm: "Hailstorm",
  mistDrift: "Drifting mist",
  windyLeaves: "Windy leaves",
  thunderRain: "Thunder rain",
  fairyDust: "Fairy dust",
  enchantedGlow: "Enchanted glow",
  champagneBubbles: "Champagne bubbles",
  floatingWisps: "Floating wisps",
  glowingRunes: "Glowing runes",
  driftingPollen: "Drifting pollen",
  autumnLeaves: "Autumn leaves",
  sakuraBloom: "Sakura bloom",
  dandelionSeeds: "Rising dandelion seeds",
  mossSporeGlow: "Moss spore glow",
  confettiParty: "Confetti party",
  neonGlowSticks: "Neon glow sticks",
  discoLights: "Disco lights",
  floatingBalloons: "Floating balloons",
  partyStreamers: "Party streamers",
  auroraWaves: "Aurora waves",
  frostSparkle: "Frost sparkle",
  cometTrail: "Comet trail",
  shootingStars: "Shooting stars",
  cherryBlossom: "Cherry blossom",
  mapleLeavesFall: "Maple leaves falling",
  goldenEmbers: "Golden embers",
  iceCrystals: "Ice crystals",
  magicSparks: "Magic sparks",
  oceanBubbles: "Ocean bubbles",
...
const TRAIL_LABELS: Record<CursorTrailKey, string> = {
  ...
  meteor: "Meteor streak",
  seeds: "Drifting seeds",
  rain: "Rain",
  fireworks: "Fireworks",
  smoke: "Smoke",
  dust: "Dust motes",
  aurora: "Aurora rings",
  frost: "Frost sparkle",
  blossom: "Blossom storm",
  stardust: "Stardust",
  cometShower: "Comet shower",
  galaxy: "Galaxy rings",
  nebula: "Nebula",
  supernova: "Supernova",
  lightning: "Lightning",
  ...
  fairyDust: "Fairy dust",
  enchanted: "Enchanted twinkle",
  potionBubbles: "Potion bubbles",
  wisps: "Wisps",
  runes: "Glowing runes",
  pollen: "Pollen",
