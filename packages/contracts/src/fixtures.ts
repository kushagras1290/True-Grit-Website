...
function generatedProductDetail(row: GeneratedProductRow): ProductDetail {
  return {
    ...
    farmSlug: "",
    region: "India",
    // The generated snapshot (catalogue.generated.json / scripts/generate_
    // catalogue_fixtures.py) predates the certifications array and still
    // carries one certification per row -- wrapped here rather than
    // regenerating the 3MB snapshot for a demo/offline-only fixture.
